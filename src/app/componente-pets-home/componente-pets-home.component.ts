...
@Component({
  selector: 'app-componente-pets-home',
  templateUrl: './componente-pets-home.component.html',
  styleUrls: ['./componente-pets-home.component.scss'],
})
export class ComponentePetsHomeComponent implements OnInit {
